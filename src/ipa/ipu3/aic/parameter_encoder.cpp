...
void ParameterEncoder::encode(aic_config *config, ipu3_uapi_params *params)
{
	...
	// todo: These functions are only here to prevent the compiler complaining
	// about them being unused until they work.:
	// ../src/ipa/ipu3/aic/parameter_encoder.cpp:277:13: error: unused function 'ispGammaCtrlEncode' [-Werror,-Wunused-function]
	// static void ispGammaCtrlEncode(aic_config *config, ipu3_uapi_params *params)
	ispAwbFrEncode(config, params); //- an assert failure
